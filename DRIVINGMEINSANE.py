...
], style={'textAlign': 'center', 'padding': '10px', 'backgroundColor': colors['background'], 'marginBottom': '20px'})

# Home page layout
home_layout = html.Div(style={'backgroundColor': colors['background'], 'padding': '20px'}, children=[
    nav_bar,
    html.H1('DNSSI Compliance Dashboard', style={'textAlign': 'center', 'color': colors['text']}),
...
detailed_layout = html.Div(style={'backgroundColor': colors['background'], 'padding': '20px'}, children=[
    nav_bar,
    html.H1('Detailed Analysis', style={'textAlign': 'center', 'color': colors['text']}),
...
comparative_layout = html.Div(style={'backgroundColor': colors['background'], 'padding': '20px'}, children=[
    nav_bar,
    html.H1('Comparative Analysis by Chapter', style={'textAlign': 'center', 'color': colors['text']}),
...
def generate_comparative_sections(pathname):
    if pathname == '/comparative':
        ...
        for theme in themes:
            ...
            section = html.Div(className='row', children=[
